...
public class ShoppingPage extends BasePage {
    ...
    private By getProductPrice(String itemName) {
        return RelativeLocator.with(By.className("inventory_item_price")).below(getItemName(itemName));
    }
    ...
    public void verifyPage() {
        ...
        Assertions.assertAll(() -> Assertions.assertTrue(find(inventoryList).isDisplayed()), () -> Assertions.assertTrue(find(productsTitle).isDisplayed()), () -> Assertions.assertTrue(find(selectItem).isDisplayed()));
    }
    ...
    public void verifyProductsPrice(List<ItemProducto> listaItems) {
        ...
        Assertions.assertAll(listaItems.stream().map(item -> () -> {
